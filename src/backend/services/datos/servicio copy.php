...
if (isset($_POST['accion']) && $_POST['accion'] === "agregar") {
    ...
    try {
        ...
        $sql = "INSERT INTO establecimiento2025 (id_establecimiemto, nombre, direccion, departamento, pais, code)
                VALUES (:id_establecimiemto, :nombre, :direccion, :departamento, :pais, :code);";

        $stmt = $dbconn->prepare($sql);
        $stmt->bindParam(':id_establecimiemto', $identifier);
   ...
   // Recolección segura de variables
    ...
    $sql = "SELECT id, id_establecimiento, nombre, direccion, departamento, pais, code
